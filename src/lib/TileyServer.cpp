...
void TileyServer::initOpenGLResources(){
    // 1. 编译和链接着色器程序
    char *vShaderSrc = LOpenGL::openShader("/home/iriseplos/projects/os/tiley/src/assets/shaders/rounded_corners_es2.vert");
    char *fShaderSrc = LOpenGL::openShader("/home/iriseplos/projects/os/tiley/src/assets/shaders/rounded_corners_es2.frag");
